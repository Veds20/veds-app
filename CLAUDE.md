...
```mermaid
graph TD
  506dc698["ERC-721 NFT"]
  b218870e["Frontend"]
  9b156934["Wallet Auth"]
  506dc698 --> b218870e
  b218870e --> 9b156934
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--506dc698.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--b218870e.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--9b156934.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--506dc698.md)
- [Frontend](.nskills/components/frontend-scaffold--b218870e.md)
- [Wallet Auth](.nskills/components/wallet-auth--9b156934.md)
